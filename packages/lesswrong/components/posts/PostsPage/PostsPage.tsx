...
const PostsPage = ({post, eagerPostComments, refetch, classes}: {
  ...
  const hasTableOfContents = showTableOfContentsSetting.get() && !!sectionData && !isCrosspostedQuestion
  ...
  const rightColumnChildren = showTableOfContentsSetting.get() && (welcomeBox || (showRecommendations && recommendationsPosition === "right")) && <>
    {welcomeBox}
