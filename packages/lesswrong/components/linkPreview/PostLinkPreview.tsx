...
const PostLinkPreviewWithPost = ({href, post, id, children, classes, showLivePreview = showLivePreviewsSetting.get}: {
  href: string,
  post: PostsList|null,
  id: string,
  ...
  if (!post || !showLivePreview()) {
    return <Components.DefaultPreview href={makeAbsolute(href)} id={id} onsite>{children}</Components.DefaultPreview>
  }
...
const CommentLinkPreviewWithComment = ({classes, href, comment, post, id, showLivePreview = showLivePreviewsSetting.get, children}: {
  classes: ClassesType,
  href: string,
  comment: any,
  post: PostsList|null,
