...
import {testServerSetting, isEAForum, isLWorAF, isWakingUp} from './instanceSettings'
...
export const dialoguesEnabled = false;
...
export const hasDigests = isEAForum || isWakingUp // Todo make back into setting
