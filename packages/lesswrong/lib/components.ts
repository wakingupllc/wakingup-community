...
importComponent("MessagesNewForm", () => require('../components/messaging/MessagesNewForm'));
...
importComponent("BookmarksPage", () => require('../components/bookmarks/BookmarksPage'));
importComponent("BookmarksList", () => require('../components/bookmarks/BookmarksList'));
...
importComponent("TagsTooltip", () => require('../components/tagging/TagsTooltip'));
