...
--
-- Overall schema hash: f23d5b34694ce7518a560c1b61f003d9

-- Accepted on 2023-11-09T01:02:14.000Z by 20231109T010214.add_subscribe_welcome_emails_config.ts
...
-- Schema for "Users", hash: e4eb75f47933064131730e5c456bc0c0
CREATE TABLE "Users" (
    _id varchar(27) PRIMARY KEY,
    "username" text,
    "emails" jsonb[],
    ...
    "notificationCommentsOnSubscribedPost" jsonb DEFAULT '{"channel":"both","batchingFrequency":"daily","timeOfDayGMT":1,"dayOfWeekGMT":"Monday"}' ::jsonb,
    ...
    "notificationRepliesToMyComments" jsonb DEFAULT '{"channel":"both","batchingFrequency":"daily","timeOfDayGMT":1,"dayOfWeekGMT":"Monday"}' ::jsonb,
    ...
    "notificationNewMention" jsonb DEFAULT '{"channel":"both","batchingFrequency":"daily","timeOfDayGMT":1,"dayOfWeekGMT":"Monday"}' ::jsonb,
