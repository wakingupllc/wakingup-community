...
--
-- Overall schema hash: aa8cfb94d8917f3abe4464e08be1175a

-- Accepted on 2024-01-18T19:47:44.000Z by 20240118T194744.merge_noop_migration.ts
...
-- Schema for "Posts", hash: 5b2560f2dee73a3bc963dd75c47c55a8
CREATE TABLE "Posts" (
    _id varchar(27) PRIMARY KEY,
    "postedAt" timestamptz NOT NULL,
...
-- Schema for "Users", hash: 7945cd1c29971231bbdee3991cafc7d8
CREATE TABLE "Users" (
    _id varchar(27) PRIMARY KEY,
    "username" text,
    "emails" jsonb[],
    ...
    "notificationCommentsOnSubscribedPost" jsonb NOT NULL DEFAULT '{"channel":"both","batchingFrequency":"realtime","timeOfDayGMT":1,"dayOfWeekGMT":"Monday"}' ::jsonb,
    "notificationShortformContent" jsonb NOT NULL DEFAULT '{"channel":"onsite","batchingFrequency":"realtime","timeOfDayGMT":1,"dayOfWeekGMT":"Monday"}' ::jsonb,
    "notificationRepliesToMyComments" jsonb NOT NULL DEFAULT '{"channel":"both","batchingFrequency":"realtime","timeOfDayGMT":1,"dayOfWeekGMT":"Monday"}' ::jsonb,
    "notificationRepliesToSubscribedComments" jsonb NOT NULL DEFAULT '{"channel":"onsite","batchingFrequency":"realtime","timeOfDayGMT":1,"dayOfWeekGMT":"Monday"}' ::jsonb,
    "notificationSubscribedUserPost" jsonb NOT NULL DEFAULT '{"channel":"onsite","batchingFrequency":"realtime","timeOfDayGMT":1,"dayOfWeekGMT":"Monday"}' ::jsonb,
    "notificationPostsInGroups" jsonb NOT NULL DEFAULT '{"channel":"both","batchingFrequency":"realtime","timeOfDayGMT":1,"dayOfWeekGMT":"Monday"}' ::jsonb,
    "notificationSubscribedTagPost" jsonb NOT NULL DEFAULT '{"channel":"onsite","batchingFrequency":"realtime","timeOfDayGMT":1,"dayOfWeekGMT":"Monday"}' ::jsonb,
    "notificationPrivateMessage" jsonb NOT NULL DEFAULT '{"channel":"both","batchingFrequency":"realtime","timeOfDayGMT":1,"dayOfWeekGMT":"Monday"}' ::jsonb,
    "notificationSharedWithMe" jsonb NOT NULL DEFAULT '{"channel":"both","batchingFrequency":"realtime","timeOfDayGMT":1,"dayOfWeekGMT":"Monday"}' ::jsonb,
    "notificationAlignmentSubmissionApproved" jsonb NOT NULL DEFAULT '{"channel":"both","batchingFrequency":"realtime","timeOfDayGMT":1,"dayOfWeekGMT":"Monday"}' ::jsonb,
    "notificationEventInRadius" jsonb NOT NULL DEFAULT '{"channel":"both","batchingFrequency":"realtime","timeOfDayGMT":1,"dayOfWeekGMT":"Monday"}' ::jsonb,
    "notificationKarmaPowersGained" jsonb NOT NULL DEFAULT '{"channel":"onsite","batchingFrequency":"realtime","timeOfDayGMT":1,"dayOfWeekGMT":"Monday"}' ::jsonb,
    "notificationRSVPs" jsonb NOT NULL DEFAULT '{"channel":"both","batchingFrequency":"realtime","timeOfDayGMT":1,"dayOfWeekGMT":"Monday"}' ::jsonb,
    "notificationGroupAdministration" jsonb NOT NULL DEFAULT '{"channel":"both","batchingFrequency":"realtime","timeOfDayGMT":1,"dayOfWeekGMT":"Monday"}' ::jsonb,
    "notificationCommentsOnDraft" jsonb NOT NULL DEFAULT '{"channel":"both","batchingFrequency":"realtime","timeOfDayGMT":1,"dayOfWeekGMT":"Monday"}' ::jsonb,
    "notificationPostsNominatedReview" jsonb NOT NULL DEFAULT '{"channel":"both","batchingFrequency":"realtime","timeOfDayGMT":1,"dayOfWeekGMT":"Monday"}' ::jsonb,
    "notificationSubforumUnread" jsonb NOT NULL DEFAULT '{"channel":"onsite","batchingFrequency":"daily","timeOfDayGMT":1,"dayOfWeekGMT":"Monday"}' ::jsonb,
    "notificationNewMention" jsonb NOT NULL DEFAULT '{"channel":"both","batchingFrequency":"realtime","timeOfDayGMT":1,"dayOfWeekGMT":"Monday"}' ::jsonb,
    "notificationDialogueMessages" jsonb NOT NULL DEFAULT '{"channel":"both","batchingFrequency":"realtime","timeOfDayGMT":1,"dayOfWeekGMT":"Monday"}' ::jsonb,
    "notificationPublishedDialogueMessages" jsonb NOT NULL DEFAULT '{"channel":"onsite","batchingFrequency":"realtime","timeOfDayGMT":1,"dayOfWeekGMT":"Monday"}' ::jsonb,
    "notificationAddedAsCoauthor" jsonb NOT NULL DEFAULT '{"channel":"both","batchingFrequency":"realtime","timeOfDayGMT":1,"dayOfWeekGMT":"Monday"}' ::jsonb,
    "notificationDebateCommentsOnSubscribedPost" jsonb NOT NULL DEFAULT '{"channel":"onsite","batchingFrequency":"daily","timeOfDayGMT":1,"dayOfWeekGMT":"Monday"}' ::jsonb,
    ...
    "notificationNewDialogueChecks" jsonb NOT NULL DEFAULT '{"channel":"none","batchingFrequency":"realtime","timeOfDayGMT":1,"dayOfWeekGMT":"Monday"}' ::jsonb,
    "notificationYourTurnMatchForm" jsonb NOT NULL DEFAULT '{"channel":"onsite","batchingFrequency":"realtime","timeOfDayGMT":1,"dayOfWeekGMT":"Monday"}' ::jsonb,
    ...
    "subscribedToWelcomeEmails" bool NOT NULL DEFAULT true,
